...
<Note>
**v1.7.1** — Figma slot support across all skills + slot-aware API previews, sub-component token ownership, composition Pattern B, and slot-safe tree traversal. [See changelog](/help/changelog).
</Note>
