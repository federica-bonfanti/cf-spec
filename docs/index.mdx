---
title: "Introduction"
description: "An AIKit that generates design system documentation for your UI components, directly from your AI agent to Figma"
---

<Note>
**v1.3** — More detailed create-voice screen reader specs with fewer tokens. Smarter focus stop discovery, automatic state grouping, and richer artwork. [See changelog](/help/changelog).
</Note>
...
uSpec is an AIKit that helps you generate structured documentation for your UI components, directly from your AI agent to Figma. You describe a component, an agent skill analyzes it using your Figma file as context, and renders the spec directly in your Figma file.
