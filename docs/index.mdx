...
<Note>
**v1.1.0** — Added support for Claude Code CLI and Codex CLI. Improved anatomy and property layer detection for complex component structures. [See changelog](/help/changelog).
</Note>
...
uSpec helps you generate structured documentation for your UI components, directly from your AI agent to Figma. You describe a component, an agent skill analyzes it using your Figma file as context, and renders the spec directly in your Figma file.
