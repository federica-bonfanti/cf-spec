...
<Steps>
  ...
  <Step title="Run the skill">
    In Cursor's chat, reference the skill, provide the JSON data (pasted directly or as a file reference), and include a Figma link to the destination page where the spec should be created:
